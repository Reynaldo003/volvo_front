...
function getLinkClass({ isActive }) {
    return [
        ...
        isActive
            ? "bg-white text-[#001C3F] shadow-sm"
...
export default function Sidebar({ onClose, isMobile = false }) {
    ...
    return (
        <aside className="flex h-full min-h-screen w-[280px] flex-col bg-[linear-gradient(180deg,#212721_0%,#425563_48%,#517891_100%)] px-4 py-5 text-white shadow-2xl">
            <div className="mb-8 flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-white/10 p-4 backdrop-blur">
                <div className="flex min-w-0 items-center gap-3">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white text-lg font-black text-[#001C3F]">
                        V
                    </div>
                ...
                {isMobile && (
                    <button
                        type="button"
                        onClick={onClose}
                        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white/10 text-white transition hover:bg-white hover:text-[#001C3F]"
            ...
            <div className="mt-6 space-y-3 border-t border-white/10 pt-4">
                ...
                <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-sm font-bold text-white/80 transition hover:bg-white hover:text-[#001C3F]"
                >
                    <LogOut size={18} />
                    Cerrar sesión
                </button>
